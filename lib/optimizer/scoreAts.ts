...
import { canonicalText } from './normalizeSkills.ts';
...
export function scoreAts(jobFacts: JobFact[], resumeText: string): AtsResult {
...
function literalPresent(haystack: string, needle: string): boolean {
