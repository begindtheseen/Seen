...
import { runHumanProof, HUMANPROOF_ENGINE_VERSION } from './index.js';
import { HUMANPROOF_WEIGHTS } from './types.js';
import { BUILTIN_PHRASE_RULES, findPhraseMatches, mergeRules } from './phraseRisk.js';
import { detectAiSlop } from './detectAiSlop.js';
import { detectBuzzwords } from './detectBuzzwords.js';
import { detectRepetition } from './detectRepetition.js';
import { detectOverclaiming } from './detectOverclaiming.js';
import { detectInterviewRisk } from './detectInterviewRisk.js';
import { explainHumanProof, computeHumanProofScore } from './explainHumanProof.js';
...
test('paid-lock behavior — gate helper returns locked CTA copy when not Pro', async () => {
  ...
  const { humanProofLockCopy } = await import('./paywall.js');
