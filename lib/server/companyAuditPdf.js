...
export function renderCompanyAuditPdf(bundle, opts = {}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    // ══ 8. PRIVACY AND PSEUDONYMIZATION ══
    sectionHeading(doc, 8, 'Privacy and pseudonymization');
    ...
    // ══ 9. LIMITATIONS AND LEGAL POSITIONING ══
    sectionHeading(doc, 9, 'Limitations and legal positioning');
    ...
    // ══ 10. CORRECTION AND DISPUTE PROTOCOL ══
    sectionHeading(doc, 10, 'Correction and dispute protocol');
    ...
    // ══ 11. APPENDIX ══
    sectionHeading(doc, 11, 'Appendix — machine-readable field summary');
    kv(doc, [
    ...
    // ══ 12. CUSTODIAN CERTIFICATION PLACEHOLDER ══
    sectionHeading(doc, 12, 'Custodian certification (placeholder)');
