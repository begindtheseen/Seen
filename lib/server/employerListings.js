// Pure helpers for EMPLOYER-MANAGED LISTINGS (api/employer-listings.js).
//
// No I/O. Validate a new employer-posted listing, build its jobs-table row (migration 055 ownership
// columns), dedupe the two apply signals (apply_events clicks + self-reported applications) into
// per-listing/per-role counts, and annotate a company's jobs rows for the dashboard table. Only
// non-identifying fields ever leave here — applicant identity is never surfaced to an employer.
