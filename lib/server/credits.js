...
export async function gateAI(req, reason = 'ai_tool', { proOnly = false } = {}) {
  ...
  // Daily reset: 3 free credits/day (code resets daily; DB DEFAULT stays 1 per migration 031).
  // Free users get enough to tune a few applications; unlimited is the Pro upgrade.
