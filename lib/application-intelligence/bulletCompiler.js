...
const FAMILY_CONTEXT = {
  ...
  marketing: 'across live campaigns and channels',
  education: 'across classes and student groups',
  project_management: 'across project delivery and stakeholders',
  skilled_trades: 'across job sites and installs',
  general: 'as a core part of the role',
};
