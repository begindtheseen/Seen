...
function pubBullet(b) {
  return { id: b.id, type: b.type, text: b.text, evidenceUsed: b.evidenceUsed, requirementsAddressed: b.requirementsAddressed, matchType: b.matchType, confidence: b.confidence, riskLevel: b.riskLevel, whySafe: b.whySafe, classification: b.classification, confirmBeforeUsing: b.confirmBeforeUsing || [], warnings: b.warnings || [] };
}
