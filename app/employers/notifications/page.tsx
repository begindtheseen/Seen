...
// The standalone notifications page is now the Updates TAB of the unified employer hub. This route
// still exists because the marketing /employers tools grid links to it — it redirects into the hub's
// updates tab, preserving ?company= and ?godview= so scoping/god-view survive the hop.

export const dynamic = 'force-dynamic'

export default async function EmployerNotificationsRedirect({
  searchParams,
}: {
